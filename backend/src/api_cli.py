...
def main():
    parser = argparse.ArgumentParser(description='CLI-based API simulator for PR analysis')
    parser.add_argument('--action', type=str, required=True, choices=['pr-summary', 'code-review'],
                      help='Action to perform (pr-summary or code-review)')
    parser.add_argument('--repo', type=str, default=SAMPLE_PR_DATA['repo'],
                      help='Repository name (e.g., username/repo)')
    parser.add_argument('--pr', type=int, default=SAMPLE_PR_DATA['pr_number'],
                      help='PR number to analyze')
    parser.add_argument('--output', type=str, default='console',
                      choices=['console', 'file'],
                      help='Output method (console or file)')
    parser.add_argument('--file', type=str, default='output.json',
